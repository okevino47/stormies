...
export const FURNITURE_CATALOG: CatalogEntryWithCategory[] = [
  ...
  { type: FurnitureType.COFFEE_TABLE,   label: 'Coffee Table',   footprintW: 1, footprintH: 1, sprite: COFFEE_TABLE_SPRITE,   isDesk: true,  category: 'desks' },
  ...
  { type: FurnitureType.POTTED_TREE,    label: 'Potted Tree',    footprintW: 1, footprintH: 2, sprite: POTTED_TREE_SPRITE,    isDesk: false, category: 'decor' },
  { type: FurnitureType.RUG,            label: 'Rug',            footprintW: 2, footprintH: 2, sprite: RUG_SPRITE,            isDesk: false, category: 'decor', backgroundTiles: 2 },
  { type: FurnitureType.WALL_CLOCK,     label: 'Wall Clock',     footprintW: 1, footprintH: 1, sprite: WALL_CLOCK_SPRITE,     isDesk: false, category: 'wall', canPlaceOnWalls: true },
